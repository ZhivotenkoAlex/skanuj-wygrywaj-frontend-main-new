<template>
    <v-dialog
        ...
        <v-card class="modelFullscreen" style="text-align: center">
            <div class="pt-12">
                <v-img
            ...
            <div class="pt-2">
                <div>
                    <img src="../../../../assets/images/receipt/check-info.png" class="progressModalImage"/>
                </div>
            </div>
            ...
            <v-btn @click="hide" class="mt-2 modalNotActionBtn mb-12">
