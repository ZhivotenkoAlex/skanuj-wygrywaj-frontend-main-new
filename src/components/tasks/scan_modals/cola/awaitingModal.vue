<template>
    <v-dialog
      ...
      <v-card class="modelFullscreen"
            ...
            <div class="pt-10 pb-10 pl-10 pr-10" style="background-color: rgb(0 0 0 / 52%);margin: 20px;border-radius: 20px;">
              <div class="pt-2 pb-5">
                <div>
                  <img src="../../../../assets/images/receipt/check.png" class="progressModalImage"/>
                </div>
              </div>
              <h5 class="modalHeader white--text">{{$t('TaskScreen.MODAL_SUCCESS_REVIEWED_TITLE')}}</h5>
              <div class="pl-5 pr-5 pb-1">
                <p class="modalInfoText white--text">{{$t('TaskScreen.MODAL_SUCCESS_REVIEWED')}}</p>
              </div>
